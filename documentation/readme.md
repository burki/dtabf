...
These are the source files of the DTA 'Base Format' documentation (version 1.2.0). The DTA 'Base Format' (DTABf) is a TEI format for the annotation of digitized historical texts. It is the annotation basis for all texts published on the Deutsches Textarchiv (DTA) platform [1].
